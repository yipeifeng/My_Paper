...
\begin{CJK*}{UTF8}{gbsn}
	...
	\begin{multicols}{2}
		...
		\begin{center}
			...
			\figcaption{\label{fig2}   Distributions of fired PMT number on different materials}
		\end{center}
	...
	\begin{multicols}{2}
		...
		backgrounds is about ??? MBytes/s. The data volume of muon events is about 100MBytes/s.
		...
		17m radius threshold the data volume of radioactity backgrounds is about ??? MBytes/s. Table.6
